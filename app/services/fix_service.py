...
class FixService:
    ...
    def _generate_diff(self, relative, source, fix, evidence, model, thinking, error):
        ...
        question = (
            ...
            "- If the fix's description or suggestion names more than one "
            "call site or line in this file, the diff MUST patch every one "
            "of them with a separate hunk. Search the CURRENT FILE CONTENT "
            "for every occurrence of the buggy pattern the fix describes — "
    ...
    def _generate_content(self, relative, source, fix, evidence, model, thinking, error):
        ...
        question = (
            ...
            "- If the fix's description or suggestion names more than one "
            "call site or line, apply the fix to every occurrence of that "
            "pattern in the file, not just the first one.\n"
